    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Delete Jobs</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                        ...
                        <div class="panel-body">
                             ...
                             $dbservername = "localhost";
                              ...
                              die("Connection failed: " . mysqli_connect_error());
                                    ...
                                    ;
                                    $query = "SELECT * FROM job_detail where job_id='$jid'";
                          ...
                          <div class="panel-body">
                            ...
                            <form action="deletejob2.php" method="post">
                                   <label>Job ID</label>
                                    ...
                                    <input class="btn btn-default" type="delete" value="delete data">
