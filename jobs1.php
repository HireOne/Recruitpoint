                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover table-info" id="dataTables-example">
                                </thead>
								<tbody >
											  <?php
					      ...
					      while($row = mysqli_fetch_assoc($result)){
									echo "<td >"."<strong>"."Job Title  "."</strong>"."<br>".$row['job_title']."<br>";
									echo "<strong>"."Job Discription"."</strong>"."<br>".$row['job_dis']."<br>";
									echo "<strong>"."Job Location  "."</strong>"."<br>".$row['Location']."<br>";
									
							               
							?>	
										<p align="right">
										<button data-toggle="tooltip" class="btn btn-primary" data-placement="top" title="view job"><span class="glyphicon glyphicon-eye-open" onClick="window.location='Cand_view.php?id=<?php echo $row['job_id'];?>'"> View</span></button>									
