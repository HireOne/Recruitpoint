						...
						<?php
                             ...
                             $dbservername = "localhost";
                              ...
                              $conn = mysqli_connect($dbservername, $dbusername, $dbpassword, $dbname) or die('unable to connect');
								...
								$query = "UPDATE job_detail SET job_title='$jobtitle', job_cat='$category ', job_dis='$jobdescription', company='$companyname', salary='$annualsalary', Location='$location', Experience='$exprience', Work_Type='$worktype ' WHERE job_id='$jobid' ";
								//echo $query;
